 ...
 * [ ] study a signal system to advertise readers for new messages (e.g., futex or eventfd) - but this may add latency and complexity, so maybe not worth it
 */
 ...
 * Reader side: instead of of spin-polling getLatest(), the reader can block:
